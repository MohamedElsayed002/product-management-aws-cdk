...
// npx cdk bootstrap aws://914561792613/eu-north-1 --force
...
export class ProductManagementStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // S3 Bucket 
    const productImagesBucket = new s3.Bucket(this, `${this.stackName}-Product-Image-Bucket`, {
      bucketName: `${this.stackName.toLowerCase()}-images-${Date.now()}`,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
    ...
    const createProductLambda = new NodejsFunction(this, `${this.stackName}-create-product-lambda`, {
      ...
      environment: {
        ...
        PRODUCTS_IMAGES_BUCKET_NAME: productImagesBucket.bucketName
      },
    ...
    new cdk.CfnOutput(this, 'ProductsImagesBucketName', {
      ...
      exportName: `${this.stackName}-Products-Images-BucketName`
    })
